...
if statusbyte between 176 and 191  ; MIDI CC
  {
    ...
    if (data1=60 and data2=65)  ; Jog wheel left
       Send {Space}
    if (data1=60 and data2=1) ; Jog wheel right
       Send {Space}
    if (data1=16 and data2=65) ; Pan knob left
       Send {Space}
    if (data1=16 and data2=1) ; Pan knob right
       Send {Space}
  }
if statusbyte between 144 and 159  ; MIDI NoteOn
  {
    stb := "NoteOn"
    if (data1=46 and data2=127) ; Bank Left
       Send {Space}
    if (data1=47 and data2=127) ; Bank Right
       Send {Space}
    if (data1=54 and data2=127) ; F1
      Send {Space}
    if (data1=55 and data2=127) ; F2
       Send {Space}
    if (data1=56 and data2=127) ; F3
      Send {Space}
    if (data1=57 and data2=127) ; F4
       Send {Space}
    if (data1=58 and data2=127) ; F5
      Send {Space}
    if (data1=53 and data2=127) ; F6
      Send {Space}
    if (data1=84 and data2=127) ; Marker
      Send {Space}
    if (data1=85 and data2=127) ; Nudge
      Send {Space}
    if (data1=86 and data2=127) ; Cycle
      Send {Space}
    if (data1=87 and data2=127) ; Drop
       Send {Space}
    if (data1=88 and data2=127) ; Replace
      Send {Space}
    if (data1=89 and data2=127) ; Click
      Send {Space}
    if (data1=90 and data2=127) ; Solo
      Send {Space}
    if (data1=96 and data2=127) ; Up
       Send {Space}
    if (data1=97 and data2=127) ; Down
       Send {Space}
    if (data1=98 and data2=127) ; Left
      Send {Space}
    if (data1=99 and data2=127) ; Right
      Send {Space}
    if (data1=91 and data2=127) ; <<
       Send {Space}
    if (data1=92 and data2=127) ; >>
       Send {Space}
    if (data1=93 and data2=127) ; Stop
       Send {Space}
    if (data1=94 and data2=127) ; Play
       Send {Space}
    if (data1=101 and data2=127) ; Scrub
      Send {Space}
    if (data1=100 and data2=127) ; Zoom
      Send {Space}
    if (data1=102 and data2=0)   ; Foot switch
      Send {Space}
  }
