...
; Adapted by Erich Grubmueller, November 2022 to support Magix Video Pro X
;@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
; =============== 
version = XTouchOne2MasgixVideoProX
; =============== 
...
if statusbyte between 176 and 191  ; MIDI CC
  {
    ...
    if (data1=60 and data2=65)
      Send ^{Left} ; Jog wheel left = Left 5 frames *
    if (data1=60 and data2=1)
      Send ^{Right} ; Jog wheel right = Right 5 frames *
    if (data1=16 and data2=65)
      Send {Right} ; Pan knob left = Left 1 frame *
    if (data1=16 and data2=1)
      Send {Left} ; Pan knob right = Right 1 frame *
  }
if statusbyte between 144 and 159  ; MIDI NoteOn
  {
    stb := "NoteOn"
	if (data1=32 and data2=127) ; Pan know press = Set keyframe * 
      Send {Numpad5}
    if (data1=46 and data2=127) ; Bank Left = Next marker*
      Send !{PgUp}
    if (data1=47 and data2=127) ; Bank Right = Previous marker*
      Send !{PgDn}
	if (data1=53 and data2=127) ; Beats Time = Streching *
      Send {0}
    if (data1=54 and data2=127) ; F1 = Ungroup *
      Send +{g}
    if (data1=55 and data2=127) ; F2 = Insert Einspur Ripple *
      Send {2}
...
;      Send {F12}
    ...
    if (data1=58 and data2=127) ; F5 = Overwrite *
      Send {5}
    if (data1=59 and data2=127) ; Group = Group *
      Send {g}
    ...
    if (data1=94 and data2=127) ; Play = Play / Pause *
      Send {Space}
	if (data1=95 and data2=127) ; Record = Record *
      Send r
